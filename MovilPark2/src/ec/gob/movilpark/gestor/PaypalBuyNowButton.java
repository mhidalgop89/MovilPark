...
public class PaypalBuyNowButton extends Button {
    ...
    private String _notify = "http://13.82.51.231/MovilPark/login";
    private String _return = "http://13.82.51.231/MovilPark/login";
    private String _cancelReturn="http://13.82.51.231/MovilPark/Aplicacion/servicios.zul";
    private Session objSession;
    
  //generate form and submit
    public void onClick(MouseEvent event) {
    	
    	System.out.println("lleha pp");
    	...
    	objSession.setMetodoPago("PP");
    	Executions.getCurrent().getSession().setAttribute("session", objSession);
    	
    	System.out.println("valor total: "+objSession.getObjPago().getValorTotal());
    	_amount=objSession.getObjPago().getValorTotal().toString();
    	//_itemName = objSession.getParquimetro().getNombre();
    	_itemName = objSession.getArea().getNombre();
    	//_itemNumber=String.valueOf(objSession.getEspacioPorParquimetro().getNumeroEspacio());
    	_itemNumber=String.valueOf(objSession.getArea().getNombre());
	...
	public void setCancelReturn(String _cancelReturn) {
		this._cancelReturn = _cancelReturn;
	}
